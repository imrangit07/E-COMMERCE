...
const Header = () => {
  ...
  return (
    <header className="sticky top-0 z-50  bg-white/80 shadow-sm backdrop-blur-md">
        ...
        <div className=" flex h-16 items-center justify-between gap-4">
          ...
          <nav className="hidden lg:flex items-center gap-6 text-sm font-medium text-gray-700">
            {Object.keys(navData).map((key) => (
              ...
              >
                <span className="hover:text-[#e79237] transition-colors cursor-pointer !uppercase">
                  {key}
                </span>
              </div>
            ))}
      ...
      <div
        className={`fixed inset-0 z-[100] bg-white transform transition-transform duration-300 ease-in-out ${isMenuOpen ? "translate-x-0" : "translate-x-full"} flex flex-col h-screen w-full overflow-y-auto `}
      >
        ...
        <div className="flex-1 px-6 pb-8 flex flex-col gap-6 overflow-y-auto ">
          ...
          <nav className="flex flex-col gap-3 text-base font-medium text-gray-700">
            <span className="py-2 border-b border-gray-100 hover:text-[#e79237] transition-colors cursor-pointer">
              Eyeglasses
            </span>
            <span className="py-2 border-b border-gray-100 hover:text-[#e79237] transition-colors cursor-pointer">
              Sunglasses
          ...
          <div className="flex flex-col gap-3 pt-4 border-t border-gray-200">
            ...
            <button className="flex items-center gap-3 py-2 text-sm text-gray-600 hover:text-[#e79237] transition-colors relative">
              ...
              <span className="text-xs font-bold bg-[#e79237] text-white rounded-full px-2 py-0.5">
                0
              </span>
            </button>
