...
const TopCategories = () => {
  ...
  const categories = [
    { id: 1, img: eye, name: "Eye Glasses", slug: "eyeglasses" },
    { id: 2, img: sun, name: "Sunglasses", slug: "sunglasses" },
    { id: 3, img: lenses, name: "Contact Lenses", slug: "contacts" },
    { id: 4, img: power, name: "Special Power", slug: "special-power" },
    { id: 5, img: kid, name: "Kids Glasses", slug: "kids-glasses" },
    { id: 6, img: sale, name: "Sale", slug: "sale" },
  ];
